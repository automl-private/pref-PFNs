...
config = MainConfig(
    ...
    warmup_epochs=100,
    train_state_dict_save_path="checkpoints_trajectories/pfn_pref_gp_6d_qeubo_trajectories_grid_10M.pt",
    train_state_dict_load_path="checkpoints_trajectories/pfn_pref_gp_6d_qeubo_trajectories_grid_10M.pt",
    validation_period=5,
    verbose=True,
    progress_bar=False,
    tensorboard_path="tb_trajectories/pref_gp_6d_qeubo_trajectories_grid_10M",
    num_workers=0,
)
