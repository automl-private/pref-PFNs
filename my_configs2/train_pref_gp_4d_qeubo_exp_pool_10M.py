...
from pfns.priors.pref.pref_gp_4d_qeubo_pool import PrefGP4DqEUBOPoolPriorConfig
...
prior = PrefGP4DqEUBOPoolPriorConfig(
    lengthscale=0.2,
    outputscale=1.0,
    noise_std=0.05,
)
...
config = MainConfig(
    ...
    warmup_epochs=100,
    train_state_dict_save_path="/work/dlclarge2/adriaens-pref-pfn/checkpoints/pfn_pref_gp_4d_qeubo_exp_pool_10M.pt",
    train_state_dict_load_path="/work/dlclarge2/adriaens-pref-pfn/checkpoints/pfn_pref_gp_4d_qeubo_exp_pool_10M.pt",
    validation_period=5,
    verbose=True,
    progress_bar=False,
    tensorboard_path="/work/dlclarge2/adriaens-pref-pfn/tb/pref_gp_4d_qeubo_exp_pool_10M",
    num_workers=0,
)
