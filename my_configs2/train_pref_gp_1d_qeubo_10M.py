...
config = MainConfig(
    ...
    warmup_epochs=100,
    train_state_dict_save_path="/work/dlclarge2/adriaens-pref-pfn/checkpoints/pfn_pref_gp_1d_qeubo_10M.pt",
    train_state_dict_load_path="/work/dlclarge2/adriaens-pref-pfn/checkpoints/pfn_pref_gp_1d_qeubo_10M.pt",
    validation_period=5,
    verbose=True,
    progress_bar=False,
    tensorboard_path="/work/dlclarge2/adriaens-pref-pfn/tb/pref_gp_1d_qeubo__10M",
    num_workers=0,
)